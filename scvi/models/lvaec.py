...
from scvi.models.modules import Encoder, DecoderSCVI, LadderDecoder, LadderEncoder, ListModule
...
class LVAEC(nn.Module):
    ...
    def __init__(self, n_input, n_labels, n_hidden=128, n_latent=10, n_layers=1, dropout_rate=0.1, n_batch=0,
        ...
        self.l_encoder = Encoder(n_input, n_hidden=n_hidden, n_latent=1, n_layers=n_layers,
        ...
        self.classifier = Classifier(n_hidden, n_hidden, n_labels=self.n_labels, n_layers=n_layers)
    ...
    def forward(self, x, local_l_mean, local_l_var, batch_index=None, y=None):
        ...
        px_scale, px_rate, px_dropout = self.decoder(self.dispersion, z1, library, batch_index)  # should never be y
    ...
    def forward_before(self, x, local_l_mean, local_l_var, batch_index=None, y=None):
        pass
        '''
        is_labelled = False if y is None else True
        ...
        px_scale, px_rate, px_dropout = self.decoder(self.dispersion, z, library, batch_index) # should never be y
