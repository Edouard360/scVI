...
# scmap.fit_scmap_cluster(countUMI, labelUMI.astype('int'))
# print("Score UMI->nonUMI:", scmap.score(countnonUMI, labelnonUMI.astype('int')))
# scmap.fit_scmap_cluster(countnonUMI, labelnonUMI.astype('int'))
# print("Score nonUMI->UMI:", scmap.score(countUMI, labelUMI.astype('int')))
# sys.exit()

latent, batch_indices, labels,keys = run_model(model_type, gene_dataset, UMI, nonUMI)
